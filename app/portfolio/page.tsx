...
export default function Page() {
  return (
    <>
      <PageHeader title="Portfolio" subtitle="A curated selection of structured, system-driven publishing work." />
      <section className="container-main py-10 text-sm text-pr_silver">
        <p>
          This page is a structured placeholder for the <strong>Portfolio</strong> section
