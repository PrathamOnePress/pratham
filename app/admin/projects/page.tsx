...
export default function Page() {
  return (
    <>
      <PageHeader title="Admin — Projects" subtitle="Tracking writing, editing, formatting, and publishing stages." />
      <section className="container-main py-10 text-sm text-pr_silver">
        <p>
          This page is a structured placeholder for the <strong>Admin — Projects</strong> section
