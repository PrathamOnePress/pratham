...
export default function Page() {
  return (
    <>
      <PageHeader title="Launch System" subtitle="30-day launch workflows, posters, reels, and discovery optimization." />
      <section className="container-main py-10 text-sm text-pr_silver">
        <p>
          This page is a structured placeholder for the <strong>Launch System</strong> section
