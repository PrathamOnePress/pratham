...
export default function Page() {
  return (
    <>
      <PageHeader title="Author Journey" subtitle="A 10-step guided path from raw idea to live published book." />
      <section className="container-main py-10 text-sm text-pr_silver">
        <p>
          This page is a structured placeholder for the <strong>Author Journey</strong> section
